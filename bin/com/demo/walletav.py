...
class Wallet:  # Clase para representar una wallet
    def __init__(self, name, address, encrypted_private_key_hex, public_key_pem, salt_hex, iv_hex, balance=13):  # Store public key as PEM string
        self.name = name
