...
document.write("<div id='consola'  onclick='display(\""+LOCATION+"\")'><a target='"+LOCATION+"' onclick='xload(`inframe.js`)' href='javascript:void(0);'><b>debuger</b></a></div>")
...
const xload = function(param='about:blank'){

LOCATION = open(this.src,LOCATION)

LOCATION.document.write('<html><head><script src=wfcore.js></script><script src="void.js"></script>')
